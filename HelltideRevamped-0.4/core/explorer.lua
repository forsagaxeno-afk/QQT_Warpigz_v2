-- explorer.lua disabled: not used by helltide tasks (explorerlite.lua is used instead).
-- This file duplicates ~70% of explorerlite and its on_update/on_render callbacks
-- waste CPU if auto-loaded by the framework.
