...
local restore_backtrack = function ()
    ...
    while index > 0 do
        ...
        -- This is an existence query; insertion order is irrelevant. Scan
        -- active frontiers instead of every historical index/hole.
        for most_recent_str, frontier_node in pairs(explorer.frontier_node) do
