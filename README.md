...
**Current release: v2.2.1.** Every version is published on the [Releases page](https://github.com/forsagaxeno-afk/QQT_Warpigz_v2/releases) with an installable package. Project release numbering started with v2.0.0. Plugin folder names and upstream history remain separate from the bundle version.
...
| `AlfredTheButler-WarPigz` | Town services (Alfred): mythic uniques, charms and seals | 1.0.1 |
